      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 leading-relaxed">
            Fuja das partes chatas. Com a nossa curadoria, você vai direto às melhores ideias do livro de forma prática, leve e divertida!
          </p>
        </div>
 
        {/* Section 2: Já li */}
        <div className="flex flex-col items-center text-center">
          <BookCheck className="w-12 h-12 text-[#f6d964] hover:text-[#222222] transition-colors duration-300 mb-4" />
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-gray-600 leading-relaxed">
            Não liga para nomes de livros? Vamos direto aos resultados! Os Temas reúnem ideias poderosas de livros diferentes. Sem historinhas.
          </p>
        </div>
